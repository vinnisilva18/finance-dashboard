  ...
  <div class="income-view">
    <div class="view-header">
      <div class="header-content">
        <h1 class="view-title">
          <q-icon name="trending_up" class="title-icon" />
          Receitas
        </h1>
        <p class="view-subtitle">Todas as receitas que entraram na sua conta</p>
      </div>
    ...
    <div class="summary-cards">
      ...
      <div class="summary-card">
        ...
        <div class="card-content">
          <div class="card-value">{{ incomeTransactions.length }}</div>
      ...
      <div class="summary-card">
        ...
        <div class="card-content">
          <div class="card-value">{{ formatCurrency(averageIncome) }}</div>
    ...
    <div class="transactions-section">
      ...
      <div v-if="viewMode === 'list'" class="transactions-list">
        <div v-if="filteredTransactions.length === 0" class="empty-state">
          ...
          <p>Adicione sua primeira receita clicando no botão acima</p>
        </div>
...
const filteredTransactions = computed(() => {
  let transactions = [...incomeTransactions.value]
...
const averageIncome = computed(() => {
  ...
  return transactions.length > 0 ? totalIncome.value / transactions.length : 0
})
